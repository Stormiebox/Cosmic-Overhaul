-- Cosmic Overhaul: ShipUtility Append
-- Avorion's VFS automatically passes the vanilla returned table as 'ShipUtility'.
-- This guarantees our modifications execute globally across ALL Virtual Machines (including the Generator VM).

-- Cached tables for massive performance gains during sector generation
