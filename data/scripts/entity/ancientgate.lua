...
if onClient() then -- only do icon stuff on the clientside
    ...
    function AncientGate.initialize(...)
        ...
        if dirKey ~= "" then
            iconPath = "data/textures/icons/pixel/cosmic_gatecompass/ancient_gate/gate_Direction" .. dirKey .. ".png"
        end
...
function initialize(...)
    if AncientGate.initialize then return AncientGate.initialize(...) end
end
