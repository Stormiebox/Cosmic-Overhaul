...
EquipmentDock.rarityFactors[3] = 0.5  -- Strongly reduced probability for normal high rarity equipment
EquipmentDock.rarityFactors[4] = 0.5  -- Strongly reduced probability for normal high rarity equipment
EquipmentDock.rarityFactors[5] = 0.25      -- Minor probability for legendaries in equipment dock
...
EquipmentDock.specialOfferRarityFactors[4] = 0.5  -- Increased probability from 0.25 to 0.5
EquipmentDock.specialOfferRarityFactors[5] = 0.25  -- Incrased probability from 0.00 to 0.25
