...
- **Trash Man Alliance/Drone Bug:** Fixed an issue where the "Trash Man" UI icon would disappear when piloting Drones or Alliance ships. The script is now safely attached globally to the Player entity rather than the physical ship.
